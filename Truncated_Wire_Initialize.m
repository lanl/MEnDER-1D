function Truncated_Wire_Initialize(Ep,LO,LI,dL,dI,IRes,nProtons,gaussParam,R,B0)
...
BInt = -(B0*R.*cot((alpha0nd')).*(log(v0'.*sin((alpha0nd')).*t2'+r0)-log(v0'.*sin((alpha0nd')).*t1'+r0)))...
    ...
    .*((prIO'<(LO*tan(0.5*alphamax)))+(prIO'>=(LO*tan(0.5*alphamax))).*...
    exp(-(prIO'-LO*tan(0.5*alphamax)).^2/(LO*tan(0.05*alphamax)).^2));
...
%Energy 1 proton positions on the image
...
%Energy 2 proton positions on the image
...
BIntline = -(B0*R.*cot((alpha0)).*(log(v0'.*sin((alpha0)).*t2'+r0)-log(v0'.*sin((alpha0)).*t1'+r0)))...
    ...
    .*((prIOline<(LO*tan(0.5*alphamax)))+(prIOline>=(LO*tan(0.5*alphamax))).*...
    exp(-(prIOline-LO*tan(0.5*alphamax)).^2/(LO*tan(0.05*alphamax)).^2));
...
print(gcf,['TruncatedWireTrajectory_2D_' num2str(round(B0)) 'T.pdf'],'-dpdf','-painters','-bestfit')
print(gcf,['TruncatedWireTrajectory_2D_' num2str(round(B0)) 'T.png'],'-dpng','-painters')
...
print(gcf,['TruncatedWireDeflection_2D_Lineout_' num2str(round(B0)) 'T.pdf'],'-dpdf','-painters','-bestfit')
print(gcf,['TruncatedWireDeflection_2D_Lineout_' num2str(round(B0)) 'T.png'],'-dpng','-painters')
...
set(gcf, 'PaperSize', [10 10])
set(gcf, 'PaperPosition', [0 0 10 10])
print(1021,['TruncatedWireImage_2D_' num2str(round(B0)) 'T_' num2str(round(Ep(1)/1e6)) '_MeV.pdf'],'-dpdf','-painters','-bestfit')
print(1021,['TruncatedWireImage_2D_' num2str(round(B0)) 'T_' num2str(round(Ep(1)/1e6)) '_MeV.png'],'-dpng')
...
set(gcf, 'PaperSize', [10 10])
set(gcf, 'PaperPosition', [0 0 10 10])
print(1022,['TruncatedWireImage_2D_' num2str(round(B0)) 'T_' num2str(round(Ep(2)/1e6)) '_MeV.pdf'],'-dpdf','-painters','-bestfit')
print(1022,['TruncatedWireImage_2D_' num2str(round(B0)) 'T_' num2str(round(Ep(2)/1e6)) '_MeV.png'],'-dpng')
...
Data2.y = ymesh*1e2;
Data2.I = pI1;
save(['Data1_TruncatedWireImage_2D_' num2str(round(B0)) 'T_' num2str(round(Ep(1)/1e6)) '_MeV'],'Data1')
save(['Data2_TruncatedWireImage_2D_' num2str(round(B0)) 'T_' num2str(round(Ep(2)/1e6)) '_MeV'],'Data2')
...
set(gcf, 'PaperSize', [10 10])
set(gcf, 'PaperPosition', [0 0 10 10])
print(165,['TruncatedWireImage_2D_Lineout_' num2str(round(B0)) 'T_' num2str(round(Ep(2)/1e6)) '_MeV.pdf'],'-dpdf','-painters','-bestfit')
print(165,['TruncatedWireImage_2D_Lineout_' num2str(round(B0)) 'T_' num2str(round(Ep(2)/1e6)) '_MeV.png'],'-dpng')

clearvars Data1 Data2

Data1 = [rI*1e2; IIr1sum];
Data2 = [rI*1e2; IIr2sum];
writematrix(Data1,['Data1_TruncatedWireImage_2D_Lineout_' num2str(round(B0)) 'T_' num2str(round(Ep(1)/1e6)) '_MeV.csv'])
writematrix(Data2,['Data2_TruncatedWireImage_2D_Lineout_' num2str(round(B0)) 'T_' num2str(round(Ep(2)/1e6)) '_MeV.csv'])

%Save the radial deflection function
Deflection1 = [px0line(1,:); alpha2line(1,:)];
Deflection2 = [px0line(2,:); alpha2line(2,:)];
writematrix(Deflection1,['Deflection1_TruncatedWireImage_2D_Lineout_'...
    num2str(round(B0)) 'T_' num2str(round(Ep(1)/1e6)) '_MeV.csv'])
writematrix(Deflection2,['Deflection2_TruncatedWireImage_2D_Lineout_'...
